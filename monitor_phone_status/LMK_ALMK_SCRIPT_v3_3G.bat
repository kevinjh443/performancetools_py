...
if %lmk_level% equ case1 (
  ...
  adb shell "echo 0,58,117,176,529,1000 > /sys/module/lowmemorykiller/parameters/adj"
  ...
  @echo has set LMK and ALMK level etc. 3G test to case1
)

if %lmk_level% equ case2 (
  adb shell "echo 0,58,117,176,529,1000 > /sys/module/lowmemorykiller/parameters/adj"
  adb shell "echo 18432,23040,27648,32256,55296,80640 > /sys/module/lowmemorykiller/parameters/minfree"
  adb shell "echo 106240 > /sys/module/lowmemorykiller/parameters/vmpressure_file_min"
  adb shell "echo 24300 > /proc/sys/vm/extra_free_kbytes"
  adb shell "echo 0 > /sys/module/process_reclaim/parameters/enable_process_reclaim"
  adb shell "echo 60 > /proc/sys/vm/swappiness"
  @echo has set LMK and ALMK level etc. 3G test to case2
)

if %lmk_level% equ case3 (
  adb shell "echo 0,117,176,411,529,1000 > /sys/module/lowmemorykiller/parameters/adj"
  adb shell "echo 18432,23040,27648,35482,66355,120960 > /sys/module/lowmemorykiller/parameters/minfree"
  adb shell "echo 159360 > /sys/module/lowmemorykiller/parameters/vmpressure_file_min"
  adb shell "echo 72900 > /proc/sys/vm/extra_free_kbytes"
  adb shell "echo 0 > /sys/module/process_reclaim/parameters/enable_process_reclaim"
  adb shell "echo 60 > /proc/sys/vm/swappiness"
  @echo has set LMK and ALMK level etc. 3G test to case3
)

if %lmk_level% equ case4 (
  adb shell "echo 0,117,176,411,529,1000 > /sys/module/lowmemorykiller/parameters/adj"
  adb shell "echo 18432,23040,27648,39030,79626,181440 > /sys/module/lowmemorykiller/parameters/minfree"
  adb shell "echo 239040 > /sys/module/lowmemorykiller/parameters/vmpressure_file_min"
  adb shell "echo 72900 > /proc/sys/vm/extra_free_kbytes"
  adb shell "echo 0 > /sys/module/process_reclaim/parameters/enable_process_reclaim"
  adb shell "echo 60 > /proc/sys/vm/swappiness"
  @echo has set LMK and ALMK level etc. 3G test to case4
)
